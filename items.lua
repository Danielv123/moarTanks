data:extend(
{
    ...
    ammo_type =
    {
      ...
      action =
      {
        ...
        {
          type = "stream",
          stream = "advanced-flamethrower-fire-stream",
          max_length = 50,
          duration = 260,
        }
      }
    ...
    attack_parameters =
    {
      ...
      gun_barrel_length = 0.9,
      gun_center_shift = { 0, -1.5 },
      range = 25,
      min_range = 1,
      cyclic_sound =
      {
    ...
    turret_animation =
    {
      ...
      {
        {
          filename = "__moarTanks__/graphics/flamethrower-turret-gun.png",
          line_length = 8,
          width = 78,
          height = 64,
          frame_count = 1,
    ...
    weight = 20000,
    inventory_size = 80,
    guns = { "tank-cannon", "tank-flame-thrower" },
  },
}
)